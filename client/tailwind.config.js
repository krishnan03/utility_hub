...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        glow:  '0 0 20px rgba(255, 99, 99, 0.2)',
      ...
      backgroundImage: {
        ...
        'gradient-primary': 'linear-gradient(135deg, #FF6363, #FF9F43)',
        'gradient-subtle':  'linear-gradient(135deg, rgba(255,99,99,0.15), rgba(255,159,67,0.15))',
      },
      animation: {
