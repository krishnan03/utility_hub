export default function Footer() {
  return (
    ...
    >
      <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-xs" style={{ color: 'var(--tp-muted)' }}>
        ...
        <a
          ...
          onMouseEnter={(e) => e.currentTarget.style.color = 'var(--tp-accent)'}
          onMouseLeave={(e) => e.currentTarget.style.color = 'var(--tp-muted)'}
        >
